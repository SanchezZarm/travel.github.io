...
const destinations = computed(() => [
  { name: t('paris'), image: '~/public/images/paris.png' },
  { name: t('rome'), image: '~/public/images//rim.png' },
  { name: t('bali'), image: '~/public/images/bali.png' },
  { name: t('baikal'), image: '~/public/images/baikal.png' }
])
