  ...
  <header class="header">
    <div class="header-top container">
      <div class="header-left">
        <a href="/" class="logo">
          <img src="~/assets/images/photoroom.png" alt="Travel Pulse" class="logo-img" />
    ...
    <div class="header-tabs container" v-if="!isMobile">
      <button class="tab-btn">
        <img src="~/assets/images/car.png" alt="car" width="20" height="20" class="tab-icon" />
        {{ t('carRental') }}
      </button>
      <button class="tab-btn">
        <img src="~/assets/images/airport.png" alt="airport" width="20" height="20" class="tab-icon" />
        {{ t('flights') }}
      </button>
      <button class="tab-btn">
        <img src="~/assets/images/bed.png" alt="bed" width="20" height="20" class="tab-icon" />
        {{ t('hotels') }}
      </button>
    </div>
    ...
    <div class="mobile-tour-form" v-else>
      ...
      <div class="mobile-dest-field">
       <img src="~/assets/images/pointer2.png"/>
